...
namespace Pulumi.Mssql.Inputs
{
    ...
    public sealed class UserServerArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("login")]
        public Input<Inputs.UserServerLoginArgs>? Login { get; set; }
