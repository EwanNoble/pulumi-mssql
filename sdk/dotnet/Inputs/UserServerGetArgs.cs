...
namespace Pulumi.Mssql.Inputs
{
    ...
    public sealed class UserServerGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Azure AD login for managing the database resources. The attributes supported in the `azure_login` block is detailed below.
        /// </summary>
        [Input("azureLogin")]
        public Input<Inputs.UserServerAzureLoginGetArgs>? AzureLogin { get; set; }
        ...
        /// </summary>
        [Input("login")]
        public Input<Inputs.UserServerLoginGetArgs>? Login { get; set; }
