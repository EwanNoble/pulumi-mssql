...
namespace Pulumi.Mssql
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Mssql.version.txt");
    ...
    internal sealed class MssqlResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
